...
variable "virtual_network_name" {
  type        = string
  description = "The name name of the virtual network"
  default     = null
}
...
variable "observability_resource_group_name" {
  type        = string
  description = "The resource group name where the log analitycs workspace is created"
  default     = null
}

variable "storage_resource_group_name" {
  type        = string
  description = "The resource group name where the storage account is created"
  default     = null
}
...
variable "public_ip_resource_group_name" {
  type        = string
  description = "The name of resource group that located the Public Ip Address"
  default     = null
}
