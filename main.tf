...
resource "azurerm_application_gateway" "main" {
  ...
  frontend_ip_configuration {
    ...
    public_ip_address_id          = var.public_ip_name != null ? data.azurerm_public_ip.pip[0].id : null
...
resource "azurerm_monitor_diagnostic_setting" "pip-diag" {
  ...
  target_resource_id         = data.azurerm_public_ip.pip[0].id
